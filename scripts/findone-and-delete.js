...
function insertDocument(collection) {
    ...
    collection.insertMany([catalog24, catalogAdams], (error, result) => {
        if (error) {
            ...
            console.log(result);
            findOneAndDeleteDocument(collection);
        }
    });
}

function findOneAndDeleteDocument(collection) {
    collection.deleteOne({ _id: '24' }, (error, result) => {
        if (error) {
            console.log(error)
        }
        else {
    ...
    collection.findOneAndDelete({ _id: 'Adams' }, (error, result) => {
        if (error) {
            console.log(error)
        }
        else {
